...
class UTrackNetV2LossWith1Channel(nn.Module):
    """
...
if __name__ == "__main__":
    ...
    # 定义模拟参数
    B, C, H, W = 4, 1, 640, 360  # 批大小=4, 类别/灰度等级=256, 尺寸=64x64

    # 1. 初始化损失函数
    loss_fn = UTrackNetV2LossWith1Channel()
    print("损失函数已初始化")
    ...
    mock_targets = torch.randint(0, 255, (B, H, W), dtype=torch.long)
